...
import { claimInvite, type AuthState } from "@/app/auth-actions";
    ...
    >
      <Card className="w-full max-w-sm">
        <CardHeader>
          ...
          <CardTitle className="text-xl">Join your shop</CardTitle>
          <CardDescription>Enter the invite code your shop owner gave you.</CardDescription>
        </CardHeader>
        <CardContent>
